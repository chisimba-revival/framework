...
class LiveUser
{
     ...
     */
    /**
     * PHP 8 constructor wrapper generated by the targeted
     * legacy-constructor moderniser.
     */
     ...
     * @see    LiveUser::getErrors
     */
    public static function &singleton(&$conf, $signature = null)
    {
        static $instances;
        if (!isset($instances)) {
            $instances = array();
     ...
     * @access public
     */
    public static function loadClass($classname, $supress_error = false)
    {
     ...
     * @access public
     */
    public static function &authFactory(&$conf, $containerName, $classprefix = 'LiveUser_')
    {
        $auth = false;
     ...
     * @access public
     */
    public static function &permFactory(&$conf, $classprefix = 'LiveUser_')
    {
        $perm = false;
     ...
     * @access protected
     */
    public static function &storageFactory(&$confArray, $classprefix = 'LiveUser_Perm_')
    {
        end($confArray);
        $key = key($confArray);
     ...
     */// LIVEUSER_ENCRYPTPW_STATIC_PHP82
public static function encryptPW($plainPW, $passwordEncryptionMode, $secret)
    {
     ...
     * @access public
     */
    public static function &cryptRC4Factory($secret)
    {
        $rc4 = false;
