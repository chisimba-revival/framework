...
$root=dirname(__DIR__,3);$page=file_get_contents(dirname(__DIR__).'/templates/page/page_template.php');$context=file_get_contents($root.'/core_modules/context/register.conf');$journey=file_get_contents($root.'/core_modules/context/classes/block_learningjourney_class_inc.php');$systext=file_get_contents($root.'/core_modules/systext/classes/systext_facet_class_inc.php');
$checks=array(
 ...
 'terminology cache follows active system type'=>str_contains($systext,"getSession('systext_type') === \$activeType")&&str_contains($systext,"setSession('systext_type'"),
);
