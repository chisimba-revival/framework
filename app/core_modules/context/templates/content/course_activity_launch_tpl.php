...
<section class="dashboard-panel course-launch" role="dialog" aria-labelledby="course-launch-title">
    <header class="dashboard-panel__header"><div>
        <p class="dashboard-eyebrow"><?php echo $e($text('mod_context_launchrequired', '[-context-] required')); ?></p>
        <h1 id="course-launch-title"><?php echo $e($text('mod_context_launchnotcurrent', 'You are not in this [-context-]')); ?></h1>
        <p><?php echo $e($text('mod_context_launchbelongs', 'This request belongs to')); ?> <?php echo $e($courseLaunchTitle); ?>.</p>
    ...
    <form class="chisimba-form" method="post" action="<?php echo $e($this->uri(array('action'=>'entercourseactivity'), 'context')); ?>">
        ...
        <div class="chisimba-actions">
            <button type="submit"><?php echo $icons->render('log-in', array('decorative'=>true)); ?> <?php echo $e($text('mod_context_launchenter', 'Enter')); ?> “<?php echo $e($courseLaunchTitle); ?>” <?php echo $e($text('mod_context_launchcontinue', 'and continue')); ?></button>
