 ...
 * @see       core
 */
class fscontext extends ChisimbaObject {
     ...
     */
    public function createContextFolder($contextCode) {
     ...
     * @param string $contextId The Context Id
     */
    public function deleletContextFolder($contextCode) {
     ...
     */
    public function copyImage($contextCode, $path, $file) {
        //STILL NEED A DECISION ON BLOBS OR FILE SYSTEM
     ...
     */
    public function newFolderInImages($contextCode, $folder) {
     ...
     */
    public function makeFolder($folder, $contextCode = NULL) {
