...
class dbparentnodes extends dbTable {
     ...
     * @return string
     */
    public function getParentNodeId($contextCode = NULL) {
     ...
     */
    public function createEntry($contextId, $contextCode, $title = NULL) {
        if (! $this->valueExists ( 'tbl_context_parentnodes_has_tbl_context_tbl_context_contextCode', $contextCode )) {
            $rootId = $this->insert ( array ('tbl_context_parentnodes_has_tbl_context_tbl_context_id' => $contextId, 'tbl_context_parentnodes_has_tbl_context_tbl_context_contextCode' => $contextCode, 'title' => $title, 'datemodified' => $this->getDate (), 'dateCreated' => $this->getDate (), 'userId' => $this->objUser->userId (), 'menu_text' => $title ) );
