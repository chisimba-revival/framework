 ...
 * Sysconfig CC class
 * 
 * Sysconfig interface class for Creative Commons (NC)
 * 
 * PHP version 3
 * 
 ...
 */
/**
* Class to provide SysConfig an input for enabling/disabling the BY/NC license
* @author Tohir Solomons
*/
class sysconfig_by_nc extends ChisimbaObject
{
    /**
    ...
    */
    function show()
    {
        ...
        $string = '<p>'.$this->objLanguage->languageText('mod_creativecommons_enableby-nc', 'creativecommons').'</p>';
