 ...
 * Sysconfig CC class
 * 
 * Sysconfig interface class for Creative Commons (GNU-FDL)
 * 
 * PHP version 3
 * 
...
*/
class sysconfig_gnu_fdl extends ChisimbaObject
{
    /**
    ...
    */
    function show()
    {
        ...
        $string = '<p>'.$this->objLanguage->languageText('mod_creativecommons_gnu-fdl', 'creativecommons').'</p>';
