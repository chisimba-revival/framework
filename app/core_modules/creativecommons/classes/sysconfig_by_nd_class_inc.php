 ...
 * Sysconfig CC class
 * 
 * Sysconfig interface class for Creative Commons (BY-ND)
 * 
 * PHP version 3
 * 
...
*/
class sysconfig_by_nd extends ChisimbaObject
{
    /**
    ...
    */
    function show()
    {
        ...
        $string = '<p>'.$this->objLanguage->languageText('mod_creativecommons_enableby-nd', 'creativecommons').'</p>';
