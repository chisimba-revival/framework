 ...
 * Sysconfig CC class
 * 
 * Sysconfig interface class for Creative Commons (BY-SA GNU FDL)
 * 
 * PHP version 3
 * 
...
*/
class sysconfig_by_sa_gnu_fdl extends ChisimbaObject
{
    /**
    ...
    */
    function show()
    {
        ...
        $string = '<p>'.$this->objLanguage->languageText('by-sa_gnu-fdl', 'creativecommons').'</p>';
