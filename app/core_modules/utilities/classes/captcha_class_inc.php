...
class captcha extends ChisimbaObject {
    ...
    function show() {
        ...
        // Creat an array
        $CAPTCHA_INIT = array ('tempfolder' => $this->tempFolder, // string: absolute path (with trailing slash!) to a writeable tempfolder which is also accessible via HTTP!
...
'secretstring' => 'A very, very secret string which is used to generate a md5-key!', 'secretposition' => 15, // integer: [1-32]
