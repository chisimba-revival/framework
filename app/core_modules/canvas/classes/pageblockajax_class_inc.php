...
/**
 *
 * Build a canvas from dyanmic blocks for page-level blocks
 *
 * This class provides the ajax that a dynamic canvas controller needs where
 * the block is indexed to a particular page.  See also moduleblockajax and
 * userblockajax for module and user blocks.
 *
 * The page keys are obtained as
 *  1. Look for a querystring called page
 *  2. Look for a querystring called pageid
 *  3. Check if it is blog, and look for the postid
 *  4. Make a hash of the URL and index by it
 *
 * PHP version 5
 *
...
class pageblockajax extends ChisimbaObject
{
    ...
    */
    public function init()
    {
       ...
       $this->objDbDynamicBlocks =  $this->getObject('dbpageblocks', 'canvas');
    }
