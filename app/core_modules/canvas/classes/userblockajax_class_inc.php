...
*
*/
class userblockajax extends ChisimbaObject
{
    ...
    */
    public function init()
    {
       ...
       $this->objDbDynamicBlocks =  $this->getObject('dbuserblocks', 'canvas');
    ...
    */
    ...
    public function addblock()
    {
        ...
        if ($block[0] == 'block' || $block[0] == 'dynamicblock') {
            // Add Block
            $result = $this->objDbDynamicBlocks->addBlock($blockId, $side, $this->userId, $block[2]);
    ...
    public function moveblock()
    {
        ...
        if ($direction == 'up') {
            $result = $this->objDbDynamicBlocks->moveBlockUp($blockId, $this->userId);
        } else {
            $result = $this->objDbDynamicBlocks->moveBlockDown($blockId, $this->userId);
        }
