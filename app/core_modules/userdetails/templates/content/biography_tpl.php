...
<aside class="chisimba-form-section chisimba-profile-preview"><?php if (!$errors && trim($value['biography']) !== ''): ?><section><h2><?php echo $e($t('bio_preview')); ?></h2><?php echo $this->getObject('authorbiographyrenderer','userdetails')->person(array_merge($value,array('userid'=>$user->userId(),'name'=>$user->fullName())), true); ?></section><?php else: ?><h2><?php echo $e($t('bio_preview')); ?></h2><p><?php echo $e($t('bio_preview_empty')); ?></p><?php endif; ?></aside>
</div></div></section>
