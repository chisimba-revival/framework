...
class storyinterface extends ChisimbaObject {
    ...
    */
    function displayData($rs, $module, $allowAdmin = false, $key = null)
    {
        ...
        $str .= "<td class=\"heading\"><a href=\""
         . $this->uri($paramArray, "stories")
         . "\">" . $this->objLanguage->languageText('word_language','stories')
         . "</a></td>\n";

        $paramArray = array('order' => 'title');
        $str .= "<td class=\"heading\"><a href=\""
         . $this->uri($paramArray, "stories")
         . "\">" . $this->objLanguage->languageText("word_title",'stories')
         . "</a></td>\n";
        ...
        $str .= "<td class=\"heading\"><a href=\""
         . $this->uri($paramArray, "stories")
         . "\">" . $this->objLanguage->languageText('phrase_expirationdate','stories')
         . "</a></td>\n";
