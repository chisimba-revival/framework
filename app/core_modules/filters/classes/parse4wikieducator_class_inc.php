...
/**
*
* Parse wiki educator content
*
* Class to parse a string (e.g. page content) that contains a Wiki educator
...
* @version   $Id: parse4wikipedia_class_inc.php 11998 2008-12-29 22:35:37Z charlvn $
...
class parse4wikieducator extends ChisimbaObject
{
    /**
    *
    ...
    */
    ...
    public function parse($txt)
    {
        ...
        preg_match_all('/\\[WIKIEDUCATOR:(.*?)\\]/', $txt, $results, PREG_PATTERN_ORDER);
    ...
    function getWikiContents($link)
    {
        ...
        if (is_array($ar[1])) {
            ...
            $page = str_replace("<a href=\"/", "<a href=\"http://wikieducator.org/", $page);
            //
            return $page;
        } else {
            return FALSE;
