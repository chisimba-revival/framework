...
* @version   $Id: parse4flag_class_inc.php 3695 2008-03-29 21:39:23Z dkeats $
 ...
 *
 */
class parse4ogg extends ChisimbaObject
{
    ...
    */
    public function parse($txt)
    {
        ...
        preg_match_all('/(\\[OGG:)(.*?)\\](.*?)(\\[\\/OGG\\])/ism', $txt, $results);
           $counter = 0;
    ...
    */
    private function setUpPage()
    {
        ...
        if (isset($this->objExpar->url)) {
            ...
            //Make it into a stream popup link
            $directLink = $this->url;
            $this->url = $this->uri(array('url' => $this->url, 'directlink' => $directLink), 'stream');
            unset($directLink);
        } else {
            $this->url=NULL;
        }
