...
class language extends dbTable {
    ...
    public function languageTextLegacy($itemName, $modulename='system', $default = false) {
        ...
        try {
            ...
            if ($notFound) {
                ...
                //:get ( string $stringID , string $pageID = TRANSLATION2_DEFAULT_PAGEID , string $langID = null , string $defaultText = '' )
    ...
    /**
     * returns a list of langs added via pear
     * @return type 
     */
    public function getLangs() {
        return $this->lang->getLangs();
    }

    /**
     *  Get a list of all the pageIDs in any table.
     */
    public function getPageIds($lang) {
        //$prefLang = $this->lang->getLang();
        $this->lang->setLang('en');
        $langs = $this->langAdmin->getPageNames();
        //$this->lang->setLang($prefLang);
        return $langs;
    }
    ...
    public function addLanguage($langData) {
        ...
        return $this->langAdmin->addLang($langData);
    }
    ...
    public function removeLanguage($langId, $destroy = FALSE) {
        ...
        return $this->langAdmin->removeLang($langId, $destroy);
    }
