...
/**
* 
* Controller class for Chisimba for the module dynamiccanvas
*
* @author Derek Keats
* @package dynamiccanvas
*
*/
class dynamiccanvas extends controller
{
    ...
    */
    ...
    /**
    * 
    * Intialiser for the dynamiccanvas controller
    * @access public
    * 
    */
    ...
    /**
     * 
     * The standard dispatch method for the dynamiccanvas module.
