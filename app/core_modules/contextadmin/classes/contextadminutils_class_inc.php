...
class contextadminutils extends ChisimbaObject {
    ...
    */
     ...
     * return $string
     */
    public function displayData($arrList, $arrHeadings = array(), $arrAdminLinks = TRUE, $orderBy = 'id') {
     ...
     * @return string
     */
    public function _getAdminLinks($contextCode) {
        $str = '';
        //course admin
        ...
        //edit
        $editArray = array ('action' => 'edit', 'fromwhere' => 'contextadmin', 'contextCode' => $contextCode );
        ...
        //delete
        $deleteArray = array ('action' => 'delete', 'contextCode' => $contextCode );
