...
<table><thead><tr><th><?php echo $e($this->objLanguage->languageText('word_name')); ?></th><th><?php echo $e($t('mod_contextadmin_authorrole')); ?></th><?php if($can): ?><th><?php echo $e($this->objLanguage->languageText('word_actions')); ?></th><?php endif; ?></tr></thead><tbody>
