...
/**
* 
* Controller class for Chisimba for the module skinselect
*
* @author Derek Keats
* @package skinselect
*
*/
class skinselect extends controller
{
    ...
    */
    ...
    /**
     * 
     * The standard dispatch method for the skinselect module.
